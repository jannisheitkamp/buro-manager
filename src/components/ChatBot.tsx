...
export const ChatBot = () => {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed bottom-24 right-6 z-[100] w-80 sm:w-96 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden transition-all duration-300 origin-bottom-right flex flex-col",
          isOpen 
      ...
      >
        ...
        <div className="bg-indigo-600 p-4 flex items-center gap-3">
          ...
          <div>
            <h3 className="text-white font-bold">Büro Bot</h3>
        ...
        <div className="p-3 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700">
          <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-700/50 rounded-full px-4 py-2">
            <input
              ...
              className="flex-1 bg-transparent focus:outline-none text-sm text-gray-900 dark:text-white placeholder-gray-500"
            />
            <button
              onClick={handleSend}
